 ...
 */
public class VrRenderersFactory2 implements RenderersFactory {
  
  private int numberOfRenderers = 0;
  private VideoRendererEventListener videoEventListeners[];
  public void setNumberOfRenderers(int numRenderers, VideoRendererEventListener[] videoListeners){
    numberOfRenderers = numRenderers;
    videoEventListeners = videoListeners;
  }
  ...
  public Renderer[] createRenderers(Handler eventHandler,
    ...
    for (int i = 0; i < numberOfRenderers; i++) {
      buildVideoRenderers(context, drmSessionManager, allowedVideoJoiningTimeMs,
              eventHandler, videoEventListeners[i], extensionRendererMode, renderersList);
    }
  ...
  private static final String TAG = "VrRenderersFactory2";
   ...
   */
  public VrRenderersFactory2(Context context) {
    this(context, null);
  }
