 ...
 */
package com.google.android.exoplayer2.dash.manifest;
...
import com.google.android.exoplayer2.dash.manifest.SegmentBase.SegmentList;
import com.google.android.exoplayer2.dash.manifest.SegmentBase.SegmentTemplate;
import com.google.android.exoplayer2.dash.manifest.SegmentBase.SegmentTimelineElement;
import com.google.android.exoplayer2.dash.manifest.SegmentBase.SingleSegmentBase;
  ...
  protected AdaptationSet parseAdaptationSet(XmlPullParser xpp, String baseUrl,
    ...
    do {
      ...
      if (XmlPullParserUtil.isStartTag(xpp, "BaseURL")) {
        ...
        Log.d("JOSH","one: " + contentType + " " + parseContentType(xpp));
